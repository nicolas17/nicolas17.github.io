...
@property (nonatomic,readonly) char shouldForceShowingSubscriberTabs; 
@property (nonatomic,readonly) char shouldSkipConnectStoreBagCheck; 
...
-(char)shouldForceShowingSubscriberTabs;
...
-(char)shouldSkipConnectStoreBagCheck;
